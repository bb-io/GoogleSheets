...
- **Find all matching row indexes** Providing a column address and a value, return all row numbers where said value is located
...
- **Copy spreadsheet** Copies an existing spreadsheet
